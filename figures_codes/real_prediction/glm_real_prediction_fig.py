...
for forecast_horizon in range(1, 13):
    testing_predictions_address = f"../../experiments/real_prediction/results/glm/{forecast_horizon}/prediction/future prediction/future prediction forecast horizon = {forecast_horizon}.csv"
...
fig.savefig('glm_real_prediction_fig.png', format='png')
fig.savefig('glm_real_prediction_fig.svg', format='svg')
