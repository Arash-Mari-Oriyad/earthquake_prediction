...
knn_accuracy_df = pd.read_csv('../../experiments/main_experiment_with_more_sub_regions/results/knn/'
                              'accuracy/testing_accuracy.csv')
...
glm_accuracy_df = pd.read_csv('../../experiments/main_experiment_with_more_sub_regions/results/glm/'
                              'accuracy/testing_accuracy.csv')
...
accuracies.append(82.47)
accuracies.append(47.68)
accuracies.append(91.28)
...
plt.ylim(0, 125)
plt.legend()
plt.savefig('main_experiment_with_more_sub_regions_fig.png', format='png')
plt.savefig('main_experiment_with_more_sub_regions_fig.svg', format='svg')
